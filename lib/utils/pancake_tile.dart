...
class PancakeTile extends StatelessWidget {
  ...
  const PancakeTile({super.key, required this.pancakeFlavour, required this.pancakePrice, required this.pancakeColor, required this.pancakeImagePath, required this.pancakeProvider});
